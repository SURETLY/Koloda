...
private let defaultRotationMax: CGFloat = 0//1.0
private let defaultRotationAngle: CGFloat = 0//CGFloat(Double.pi) / 10.0
private let defaultScaleMin: CGFloat = 1//0.8
